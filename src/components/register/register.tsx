...
export default function Register() {
	...
	return (
		<div className="flex flex-row w-1/2">
			<div className="left w-2/6 bg-primary">
				<Carousel transition={{ duration: 2 }} className="rounded-xl" placeholder={undefined}>
					<p>Agam</p>
					<p>is</p>
					<p>here</p>
				</Carousel>
			...
			<div className=" w-2/3 relative flex flex-col text-gray-700 bg-white shadow-md bg-clip-border">
				...
				<form className="flex flex-col gap-4 px-6 pb-6 h-96 overflow-y-auto" onSubmit={handleRegister}>
					...
					<div className="relative h-10 min-w-[200px]">
						<select
							className="peer h-full w-full rounded-[7px] border border-blue-gray-200  bg-transparent px-3 py-0 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 empty:!bg-white-900 focus:border-2 focus:border-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
							name="stream"
