	...
	return (
		<>
			<div className="shadow-lg">
				<div className="relative rounded-lg h-56 w-96">
					<div className="absolute inset-0 bg-[#8d6e63] bg-opacity-50 rounded-t-lg"></div>
					<div className="absolute  p-4 flex flex-col w-96 rounded-b-lg text-white">
				...
				<div className="bg-white p-4 flex gap-4 w-96 rounded-b-lg">
					<div>
