...
export default function LoginForm() {
	...
	const sendOTP = async () => {
		setOTPSend(true)
		try {
			const response = await axios.post('src/utils/sendOtp', { phoneNumber });
		...
		<div className="flex flex-row w-1/2">
			<div className="left w-2/6 bg-primary pl-2">
				<Carousel slides={[
					...
					<p>is</p>,
					<p>Education Library
						Get detailed information about Colleges, Careers, Courses, and Exams at CollegeDekho. Register now and make informed decisions about your career.</p>
				]} showPagination={true} showButton={false} slidesDesktop={1} slideGap="gap-0" paginationAlignment="justify-left" borderColor="black">
				</Carousel>
			</div>
			<div className="w-3/4 relative flex flex-col text-gray-700 bg-white shadow-md bg-clip-border py-12 px-6">
				...
				<div className="flex items-center flex-col">
					<h3 className="block font-sans text-2xl mb-2 antialiased font-semibold leading-snug tracking-normal text-black">OTP Verification</h3>
					<span className="block font-sans text-sm text-black text-center mb-4">We will send you an one time password on your mobile number</span>
				</div>
