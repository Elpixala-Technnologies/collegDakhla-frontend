...
export default function CollegeList(){
    const collageList = [
        ...
        {id:"3",name:"NIT - Indian Institute of Technology - [IITM] Chennai",
        location:"Chennai",
        state:"Tamil Nadu", 
        affiliate:"AICTE Aprroved",
        fee:"200000",
        ...
        {id:"4",name:"Amity - Indian Institute of Technology - [IITM] Chennai",
        location:"Chennai",
        state:"Tamil Nadu", 
        affiliate:"AICTE Aprroved",
        fee:"200000",
        ...
        {id:"5",name:"DTC - Indian Institute of Technology - [IITM] Chennai",
        location:"Chennai",
        state:"Tamil Nadu", 
        affiliate:"AICTE Aprroved",
        fee:"200000",
    ...
    useEffect(()=>{
      setList(collageList.filter(item=>item.name.toLowerCase().includes(Search.toLowerCase())));
    },[Search])
            ...
            <div className="flex flex-col md:flex-row gap-4 px-4">
              ...
              <div className="flex-1  w-full overflow-hidden">
                ...
                {List.map((college,index) => {
                    return (
                      <>
                        <CollegeListItem key={Math.random()*1000} college={college} />
                        {
                          (index+1)==4? 
                            <div>
