...
const MorePage = () => {
  ...
  return (
    <section className="max-w-screen-2xl mx-auto overflow-x-hidden">
		{/* section 1  */}
      <div className="flex flex-col md:flex-row gap-6 md:gap-1 justify-between max-w-screen-xl mx-auto items-center px-8 md:px-4">
        <div className="w-full  flex flex-col gap-6 flex-[1]">
            ...
            >
              <div className="max-sm:mt-5 text-4xl sm:text-6xl">
              ...
              >
                ...
                <AnimatePresence>
                  {isHovered && (
                    ...
                    >
                      <span className="text-orange-500">AKHLA</span>
                    </motion.span>
                  )}
                </AnimatePresence>
              </motion.div>
            </a>
          <h2 className="text-xl md:text-4xl leading-tight">
            Confused about{" "}
            <span className="font-bold">the best career fit</span> for you?
          </h2>
          <WavyText
            text="Discover your strengths and interests for a better career fit with
            our College Dakhla."
            textSize="text-md text-wrap"
            replay={replay}
			className=" flex-wrap"
          />
          <Button
        ...
        <Image
          className="object-contain flex-[1] h-96"
          src={Man}
          alt="more-hero"
          height={500}
          width={500}
      ...
      <div className="flex justify-center items-center py-10 md:py-16 my-5 bg-gradient-to-b from-orange-600 via-orange-300 to-orange-100">
        <div className="flex flex-col md:flex-row gap-10 md:gap-2 justify-between max-w-screen-xl mx-auto items-center px-8 md:px-4 text-white">
          ...
          <Image
            className="object-contain h-96 flex-[1]"
            src={LearnTest}
            alt="more-middle"
            height={500}
            width={500}
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-2 justify-between max-w-screen-xl mx-auto items-center px-8 md:px-4">
          <div className="w-full flex flex-col gap-3 flex-[1]">
			...
			<p className="text-justify">
              ...
              derived from dimediumverse evaluation criteria.
            </p>
          </div>
