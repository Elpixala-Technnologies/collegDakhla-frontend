...
import {Bufferrr, LearnTest, Man, Study, TeamWork, Women} from '../../Asset/index';
...
const MorePage = () => {
    ...
    return (
      <>    
        ...
        <div
          className="flex justify-center items-center py-10 md:py-16 my-5 bg-gradient-to-b from-orange-600 via-orange-300 to-orange-100"
        ...
        <div className="mt-10 mb-10 max-w-screen-xl mx-auto px-8 md:px-4 py-6 md:py-3 flex flex-col gap-14 md:gap-3 md:flex-row justify-between items-center">
          <div className="w-full md:w-1/2 flex flex-col gap-3 relative">
            <h2 className="text-[40px] leading-tight">
              ...
              College Dakhla Assessment?
              </span>
            </h2>
            <p>
              Introducing our College Dakhla, meticulously
            ...
            <p>
              Through the College Dakhla, you'll unearth
            ...
            {expend && (
              <p>
                Through the College Dakhla, you'll unearth
                your inherent strengths and areas for development, empowering
                you to navigate career choices, interpersonal relationships, and
                personal evolution with clarity. Whether you seek to refine your
                communication prowess, bolster leadership acumen, or deepen
                self-awareness, our assessment equips you with the discernment
                needed for holistic growth.
        ...
        <div className="bg-gradient-to-r opacity-80 from-blue-100 to-white py-10 md:py-16">
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-2 justify-between max-w-screen-xl mx-auto items-center px-8 md:px-4">
            <div className="w-full md:w-1/2 flex flex-col gap-6">
              <p className="text-md">
                Explore your strengths with our College Dakhla
                Assessment Test.
              </p>
              <p>
                The College DakhlaAssessment is grounded in the
                RIASEC model, providing comprehensive career reports accompanied
                by personalized development strategies. Receive tailored career
                recommendations derived from diverse evaluation criteria.
              </p>
            </div>
        ...
        <div className="bg-gradient-to-r opacity-80 from-blue-100 to-white flex justify-center items-center py-8">
          <div className="flex flex-col md:flex-row gap-10 md:gap-2 justify-between max-w-screen-xl mx-auto items-center px-8 md:px-4">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-6">
              <p className="text-md">
                Uncover your strengths with our College Dakhla
                Assessment Test.
              </p>
              <p>
                Our College Dakhla Assessment is rooted in the RIASEC
                model, offering detailed career reports coupled with
                personalized development plans. Receive tailored career
                recommendations based on a wide array of evaluation parameters.
              </p>
            </div>
          </div>
        </div>
        <div className="bg-gradient-to-r opacity-80 from-blue-100 to-white flex justify-center items-center py-8">
          <div className="flex flex-col md:flex-row gap-10 md:gap-2 justify-between max-w-screen-xl mx-auto items-center px-8 md:px-4">
            <div className="w-full md:w-1/2 flex flex-col gap-6">
              <p className="text-md">
                Unlock your potential with our College Dakhla
                Assessment Test.
              </p>
              <p>
                Our College Dakhla Assessment is meticulously
                designed to align with the RIASEC model. Gain access to
                comprehensive career reports featuring personalized development
                plans tailored to your unique strengths and aspirations. Receive
                expert guidance and best-fit career recommendations derived from
                a diverse range of evaluation parameters.
              </p>
            </div>
            <Image
              className="object-contain lg:w-1/3 md:w-1/2 w-2/3"
        ...
        <div className="bg-gradient-to-r opacity-80 from-blue-100 to-white flex justify-center items-center py-12">
          <div className="flex flex-col md:flex-row gap-10 md:gap-2 justify-between max-w-screen-xl mx-auto items-center px-8 md:px-4">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-6">
              <p className="text-md">
                Explore your strengths with ourCollege Dakhla
                Assessment Test.
              </p>
              <p>
                The College Dakhla Assessment is rooted in the RIASEC
